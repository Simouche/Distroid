...
abstract class BaseFragment : Fragment() {
    ...
    protected fun success(@StringRes messageId: Int? = null, message: String? = null) {
        if (messageId != null)
            DynamicToast.makeSuccess(requireContext(), getString(messageId), Toast.LENGTH_LONG).show()
        else
    ...
    protected fun warning(@StringRes messageId: Int? = null, message: String? = null) {
        if (messageId != null)
            DynamicToast.makeWarning(requireContext(), getString(messageId), Toast.LENGTH_LONG).show()
        else
